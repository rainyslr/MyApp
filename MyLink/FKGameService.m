...
- (FKPiece*) findPieceAtTouchX:(CGFloat) touchX touchY:(CGFloat) touchY
{
	...
	CGFloat relativeX = touchX - self.board.Begin_X;
	CGFloat relativeY = touchY - self.board.Begin_Y;
	...
	height:(NSInteger)pieceHeight
{
	...
	// 获取FKBaseBoard的最大高度
	NSInteger heightMax = (ySize + 1) * pieceHeight + self.board.Begin_X;
	// 获取FKBaseBoard的最大宽度
	NSInteger widthMax = (xSize + 1) * pieceWidth + self.board.Begin_Y;
